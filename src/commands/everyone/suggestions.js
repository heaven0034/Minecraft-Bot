...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const suggestionsChannel = message.guild.channels.cache.get('1100039238038339684'); // Mettre l'ID du salon suggestion, la commande sera faisable uniquement dans le salon de suggestions
